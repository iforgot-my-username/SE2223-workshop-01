...
function App() {
  ...
  const items = [
    { name: 'hoody-A', price: 2001, markDown: 1908.11, event: new Date('mar 11, 2022 11:30:00 pm'), pictureSrc: "https://image.shutterstock.com/image-vector/vector-cartoon-illustration-pink-hoodie-260nw-1420438379.jpg" },
    ...
    { name: 'hoody-A', price: 2002, markDown: 1908.11, event: new Date('mar 11, 2022 11:30:00 pm'), pictureSrc: "https://image.shutterstock.com/image-vector/vector-cartoon-illustration-pink-hoodie-260nw-1420438379.jpg" },
    { name: 'hoody-D', price: 2050, markDown: 1500, event: new Date('mar 21, 2022 1:40:00 pm'), pictureSrc: "https://thumbs.dreamstime.com/b/vector-single-cartoon-illustration-red-hoodie-sweatshirt-128756703.jpg" },
    ...
    { name: 'hoody-A', price: 2003, markDown: 1908.11, event: new Date('mar 11, 2022 1:23:01 pm'), pictureSrc: "https://image.shutterstock.com/image-vector/vector-cartoon-illustration-pink-hoodie-260nw-1420438379.jpg" },
    { name: 'hoody-b', price: 2001, markDown: 1999.99, event: new Date('mar 11, 2022 1:23:01 pm'), pictureSrc: "https://cdn4.vectorstock.com/i/1000x1000/82/98/men-hoodies-icon-cartoon-vector-13948298.jpg" },
    ...
    { name: 'hoody-b', price: 2002, markDown: 1999.99, event: new Date('mar 11, 2022 1:23:01 pm'), pictureSrc: "https://cdn4.vectorstock.com/i/1000x1000/82/98/men-hoodies-icon-cartoon-vector-13948298.jpg" },
    { name: 'hoody-A', price: 2000, event: new Date('mar 11, 2022 1:23:01 pm'), pictureSrc: "https://htdraw.com/wp-content/uploads/2020/09/how-to-draw-a-hoodie-370x297.jpg" },
